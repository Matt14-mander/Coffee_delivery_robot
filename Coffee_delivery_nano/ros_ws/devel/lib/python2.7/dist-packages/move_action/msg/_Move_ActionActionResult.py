...
"""autogenerated by genpy from move_action/Move_ActionActionResult.msg. Do not edit."""
import codecs
import sys
...
class Move_ActionActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "move_action/Move_ActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move_action/Move_ActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Move_ActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = move_action.msg.Move_ActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = move_action.msg.Move_ActionResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.result = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.result = str[start:end]
      return self
