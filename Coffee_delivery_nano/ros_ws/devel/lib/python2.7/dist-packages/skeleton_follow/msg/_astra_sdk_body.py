...
"""autogenerated by genpy from skeleton_follow/astra_sdk_body.msg. Do not edit."""
import codecs
import sys
...
class astra_sdk_body(genpy.Message):
  _md5sum = "57f2da357721aaca7548e8de3d97f76a"
  _type = "skeleton_follow/astra_sdk_body"
...
float32 y"""
  ...
  _slot_types = ['int16','skeleton_follow/astra_sdk_vector3f','skeleton_follow/astra_sdk_joint[19]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(astra_sdk_body, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.bodyid is None:
        self.bodyid = 0
      if self.centerOfMass is None:
        self.centerOfMass = skeleton_follow.msg.astra_sdk_vector3f()
      if self.joints is None:
        self.joints = [skeleton_follow.msg.astra_sdk_joint() for _ in range(19)]
    else:
      self.bodyid = 0
      self.centerOfMass = skeleton_follow.msg.astra_sdk_vector3f()
      self.joints = [skeleton_follow.msg.astra_sdk_joint() for _ in range(19)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints = []
      for i in range(0, 19):
        val1 = skeleton_follow.msg.astra_sdk_joint()
        start = end
        end += 1
