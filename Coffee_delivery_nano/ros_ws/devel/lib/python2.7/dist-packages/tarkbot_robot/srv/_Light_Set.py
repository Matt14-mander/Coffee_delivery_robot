...
"""autogenerated by genpy from tarkbot_robot/Light_SetRequest.msg. Do not edit."""
import codecs
import sys
...
class Light_SetRequest(genpy.Message):
  ...
  _type = "tarkbot_robot/Light_SetRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 客户端请求时发送的四个数字
int8 RGB_M_
int8 RGB_S_
uint8 RGB_T_
uint8 RGB_R_
...
def _get_struct_2b4B():
    ...
    return _struct_2b4B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tarkbot_robot/Light_SetResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class Light_SetResponse(genpy.Message):
  ...
  _type = "tarkbot_robot/Light_SetResponse"
  _has_header = False  # flag to mark the presence of a Header object
