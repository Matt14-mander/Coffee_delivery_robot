...
(cl:defmethod cl:initialize-instance :after ((m <Lidar_Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lidar_Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rplidar_ros-msg:<Lidar_Angle> is deprecated: use rplidar_ros-msg:Lidar_Angle instead.")))

(cl:ensure-generic-function 'start_angle-val :lambda-list '(m))
(cl:defmethod start_angle-val ((m <Lidar_Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rplidar_ros-msg:start_angle-val is deprecated.  Use rplidar_ros-msg:start_angle instead.")
  (start_angle m))

(cl:ensure-generic-function 'end_angle-val :lambda-list '(m))
(cl:defmethod end_angle-val ((m <Lidar_Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rplidar_ros-msg:end_angle-val is deprecated.  Use rplidar_ros-msg:end_angle instead.")
  (end_angle m))
