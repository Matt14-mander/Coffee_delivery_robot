...
(cl:in-package tarkbot_robot-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Light_Set-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Light_Set-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarkbot_robot-srv:<Light_Set-request> is deprecated: use tarkbot_robot-srv:Light_Set-request instead.")))

(cl:ensure-generic-function 'RGB_M_-val :lambda-list '(m))
(cl:defmethod RGB_M_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_M_-val is deprecated.  Use tarkbot_robot-srv:RGB_M_ instead.")
  (RGB_M_ m))

(cl:ensure-generic-function 'RGB_S_-val :lambda-list '(m))
(cl:defmethod RGB_S_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_S_-val is deprecated.  Use tarkbot_robot-srv:RGB_S_ instead.")
  (RGB_S_ m))

(cl:ensure-generic-function 'RGB_T_-val :lambda-list '(m))
(cl:defmethod RGB_T_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_T_-val is deprecated.  Use tarkbot_robot-srv:RGB_T_ instead.")
  (RGB_T_ m))

(cl:ensure-generic-function 'RGB_R_-val :lambda-list '(m))
(cl:defmethod RGB_R_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_R_-val is deprecated.  Use tarkbot_robot-srv:RGB_R_ instead.")
  (RGB_R_ m))

(cl:ensure-generic-function 'RGB_G_-val :lambda-list '(m))
(cl:defmethod RGB_G_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_G_-val is deprecated.  Use tarkbot_robot-srv:RGB_G_ instead.")
  (RGB_G_ m))

(cl:ensure-generic-function 'RGB_B_-val :lambda-list '(m))
(cl:defmethod RGB_B_-val ((m <Light_Set-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:RGB_B_-val is deprecated.  Use tarkbot_robot-srv:RGB_B_ instead.")
  (RGB_B_ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Light_Set-request>)))
  ...
  "tarkbot_robot/Light_SetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Light_Set-request)))
  "Returns string type for a service object of type 'Light_Set-request"
  "tarkbot_robot/Light_SetRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Light_Set-request>)))
  ...
  (cl:format cl:nil "# 客户端请求时发送的四个数字~%int8 RGB_M_~%int8 RGB_S_~%uint8 RGB_T_~%uint8 RGB_R_~%uint8 RGB_G_~%uint8 RGB_B_~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Light_Set-request)))
  "Returns full string definition for message of type 'Light_Set-request"
  (cl:format cl:nil "# 客户端请求时发送的四个数字~%int8 RGB_M_~%int8 RGB_S_~%uint8 RGB_T_~%uint8 RGB_R_~%uint8 RGB_G_~%uint8 RGB_B_~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Light_Set-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Light_Set-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarkbot_robot-srv:<Light_Set-response> is deprecated: use tarkbot_robot-srv:Light_Set-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Light_Set-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarkbot_robot-srv:result-val is deprecated.  Use tarkbot_robot-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Light_Set-response>)))
  ...
  "tarkbot_robot/Light_SetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Light_Set-response)))
  "Returns string type for a service object of type 'Light_Set-response"
  "tarkbot_robot/Light_SetResponse")
