...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/xtark/tarkbot/ros_ws/src/tarkbot_package/open_karto)
  set(open_karto_DEVEL_PREFIX /home/xtark/tarkbot/ros_ws/devel)
  ...
  set(open_karto_INSTALL_PREFIX /home/xtark/tarkbot/ros_ws/install)
...
if(NOT "/home/xtark/tarkbot/ros_ws/src/tarkbot_package/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/xtark/tarkbot/ros_ws/src/tarkbot_package/open_karto/include;/usr/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Michael Ferguson <mfergs7@gmail.com>, Russell Toris <rtoris@fetchrobotics.com>, Luc Bettaieb <luc.bettaieb@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xtark/tarkbot/ros_ws/src/tarkbot_package/open_karto/${idir}'.  ${_report}")
    endif()
    _list_append_unique(open_karto_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "karto;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT open_karto_NUM_DUMMY_TARGETS)
      set(open_karto_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::open_karto::wrapped-linker-option${open_karto_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR open_karto_NUM_DUMMY_TARGETS "${open_karto_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::open_karto::wrapped-linker-option${open_karto_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND open_karto_LIBRARIES "${interface_target_name}")
...
set(depends "sparse_bundle_adjustment")
