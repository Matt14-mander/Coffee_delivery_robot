...
if("TRUE" STREQUAL "TRUE")
  set(track_pkg_SOURCE_PREFIX /home/xtark/tarkbot/ros_ws/src/tarkbot_demo/track_pkg)
  set(track_pkg_DEVEL_PREFIX /home/xtark/tarkbot/ros_ws/devel)
  ...
  set(track_pkg_INSTALL_PREFIX /home/xtark/tarkbot/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'exbot <exbot@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xtark/tarkbot/ros_ws/src/tarkbot_demo/track_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT track_pkg_NUM_DUMMY_TARGETS)
      set(track_pkg_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::track_pkg::wrapped-linker-option${track_pkg_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR track_pkg_NUM_DUMMY_TARGETS "${track_pkg_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::track_pkg::wrapped-linker-option${track_pkg_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND track_pkg_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${track_pkg_dep}_FOUND)
      find_package(${track_pkg_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${track_pkg_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
