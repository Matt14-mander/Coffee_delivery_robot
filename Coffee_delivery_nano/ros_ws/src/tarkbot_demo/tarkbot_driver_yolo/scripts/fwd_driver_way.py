...
def side_flag_callback(msg):
	...
	if msg.data == [] or msg.data[0].frame_id == "Green_light":
		...
		if msg.data[0].ptx > 510 and msg.data[0].pty < 200 and msg.data[0].pty > 180 and msg.data[0].distw < 60 and msg.data[0].distw > 45:
			side_flag = 2
	elif msg.data[0].frame_id == "Red_light" and last_tarkbot_driver_way == 2:
		if msg.data[0].ptx > 506 and msg.data[0].pty > 175 and msg.data[0].pty < 185: 
			stop_flag = 1
			stop_temp = 0
	elif msg.data[0].frame_id == "Parking_lotB" or  msg.data[0].frame_id == "Parking_lotA":
		if msg.data[0].ptx > 490 and msg.data[0].ptx < 530 and msg.data[0].pty > 180 and msg.data[0].pty <199 and msg.data[0].distw >35:
			park_flag = 1
