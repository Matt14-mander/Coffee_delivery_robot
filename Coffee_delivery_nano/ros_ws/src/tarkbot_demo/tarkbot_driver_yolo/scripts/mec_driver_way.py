...
def side_flag_callback(msg):
	...
	if msg.data == [] or msg.data[0].frame_id == "Green_light":
		...
		if msg.data[0].ptx > 495 and msg.data[0].ptx < 510 and msg.data[0].pty < 198 and msg.data[0].pty > 185 and msg.data[0].disth > 45:
			side_flag = 2
	elif msg.data[0].frame_id == "Red_light":
		if msg.data[0].ptx > 560 and msg.data[0].pty < 185 and msg.data[0].pty > 165:
			stop_flag = 1
			stop_temp = 0
	elif msg.data[0].frame_id == "Parking_lotB" or msg.data[0].frame_id == "Parking_lotA":
		if msg.data[0].ptx > 495 and msg.data[0].pty > 175 and msg.data[0].pty <200 and msg.data[0].distw >43:
			park_flag = 1
